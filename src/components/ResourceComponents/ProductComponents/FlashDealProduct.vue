      ...
      <div class="container">
       <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
         <!-- <div class="d-flex mb-3 align-items-baseline border-bottom sectionmenu">
           ...
           <router-link :to="{name:'productShop'}" class="ml-auto mr-0 btn btn-primary btn-sm shadow-md">View All</router-link>
         </div> -->
         <div class="d-flex flex-wrap mb-3 align-items-baseline border-bottom">
                    <h3 class="h5 fw-700 mb-0">
                        <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">Flash Deal</span>
                    </h3>
                    <div class="aiz-count-down ml-auto ml-lg-3 align-items-center" data-date="">Time Here</div>
                    <a href="" class="ml-auto mr-0 btn btn-primary btn-sm shadow-md w-100 w-md-auto">View More</a>
                </div>
         <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4" data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'>
          ...
          <swiper
                ...
                class="mySwiper"
              >
          <swiper-slide v-for="(product, index) in flashDeal" :key="index">  
...
import { ratingGenerator } from '@/HelpersFunction/Helpers';
  ...
  export default {
    ...
    created(){
        this.getFlashProducts(this.rootDomain);
    },
    mounted(){
   
    },
    methods: {
        getFlashProducts(rootDomain){
            axios.get(rootDomain+'vue/flash-deal-product')
            .then((response)=>{
                this.flashDeal = response.data.data;
            })
      },
      productDetails(slug){
      this.$router.push({
