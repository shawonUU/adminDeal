<template>
   <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3 text-primary">Welcome to Seller Dashboard</h1>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3 mb-4">
            <div class="card shadow-none h-450px mb-0 h-100">
                <div class="card-body">
                    <div class="card-title text-primary fs-16 fw-600">
                       Coming Soon More Feature
                    </div>
                    <hr>
                    <ul class="list-group">
                        <span class="" style="font-size:12px">সম্মানিত সেলার, আমরা আরও অনেক ফিচার নিয়ে কাজ করছি, খুব শীঘ্রই আপনাদের সেবায় আরও নতুন নতুন ফিচার যোগ করা হবে। আমরা আপনার পণ্য ও অর্থের শতভাগ নিশ্চয়তা দিচ্ছি। আপনিও এডমিন ডিলের সকল কাস্টমারকে গুনগত পণ্য সঠিক সময়ে ডেলিভারি দিন। আপনার কোন সাহায্য বা তথ্যের জন্য আমাদের সাপোর্ট এ কথা বলতে পারেন। সেলার ড্যাশবোর্ড থেকে সাপোর্ট বোর্ড হাইড আছে। সাপোর্ট বোর্ডের জন্য, অন্য কোন ব্রাউজার বা ইনকগনিডো মুড ব্যবহার করতে পারেন। ধন্যবাদ, এডমিন ডিলের সাথে জন্য। </span>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary">
                ...
                <a href="seller.shop.index" class="btn btn-primary">
                    Go to setting
                </a>
            </div>
        </div>
        <div class="col-sm-6 col-md-6 col-lg-3">
            <div class="card mb-4 p-4 text-center bg-soft-primary">
                ...
                <a href="seller.profile.index" class="btn btn-primary">
                   Configure Now
                </a>
            </div>
        </div>
